...
def is_edge_point (x, y, z, mask, mask_resolution, rmin, rmax, edge_buffer = 30 ):
    
    is_edge = False
    #-------------------------------------------------------------------
    # Is the point within 30 Mpc/h of the survey boundary?
    #-------------------------------------------------------------------
    # Calculate coordinates that are 30 Mpc/h in each Cartesian 
